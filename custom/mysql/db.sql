...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2015 at 08:42 PM
...
--
-- Table structure for table `mqmj3_assets`
--

CREATE TABLE IF NOT EXISTS `mqmj3_assets` (
...
--
-- Dumping data for table `mqmj3_assets`
--

INSERT INTO `mqmj3_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(55, 27, 19, 20, 3, 'com_content.article.1', 'About', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_associations`
--

CREATE TABLE IF NOT EXISTS `mqmj3_associations` (
...
--
-- Table structure for table `mqmj3_banners`
--

CREATE TABLE IF NOT EXISTS `mqmj3_banners` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `mqmj3_banner_clients`
--

CREATE TABLE IF NOT EXISTS `mqmj3_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `mqmj3_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `mqmj3_banner_tracks` (
...
--
-- Table structure for table `mqmj3_categories`
--

CREATE TABLE IF NOT EXISTS `mqmj3_categories` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `mqmj3_categories`
--

INSERT INTO `mqmj3_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `mqmj3_contact_details`
--

CREATE TABLE IF NOT EXISTS `mqmj3_contact_details` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `mqmj3_content`
--

CREATE TABLE IF NOT EXISTS `mqmj3_content` (
...
--
-- Dumping data for table `mqmj3_content`
--

INSERT INTO `mqmj3_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 55, 'About', 'about', '<p style="margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;"><img src="images/custom/maria-queen-maria-logo.png" alt="Maria Queen Maria Logo" width="782" height="156" /></p>\r\n<p style="margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;">Maria Queen Maria fashion label was established on a sunny, December day of 2009 under the sign of Sagittarius and Jupiter and a result of a long-standing friendship between a Capricorn and an Aries.</p>\r\n<p style="margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;">In less than four years MQM became a major brand and the only Bulgarian label for deconstructive fashion.<br />For the double "M" stand the talent and visionary work of Mina Kaye and Maria Ilieva - popular and prominent factors in the Bulgarian show business and fashion.</p>\r\n<p style="margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;">Over the last ten years Mina and Maria developed their own, original fashion line,  believing  that Sofia can now boost with avan-garde deconstructive designs and dictate trends.<br />Maria Queen Maria fashion stores are situated on the the unique Rakovski 193 street.</p>', '', 1, 2, '2015-06-09 17:36:56', 252, '', '2015-06-09 18:34:01', 252, 0, '0000-00-00 00:00:00', '2015-06-09 17:36:56', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"0","show_tags":"0","show_intro":"0","info_block_position":"","show_category":"0","link_category":"0","show_parent_category":"0","link_parent_category":"0","show_author":"0","link_author":"0","show_create_date":"0","show_modify_date":"0","show_publish_date":"0","show_item_navigation":"0","show_icons":"0","show_print_icon":"0","show_email_icon":"0","show_vote":"0","show_hits":"0","show_noauth":"0","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"0","show_article_options":"0","show_urls_images_backend":"0","show_urls_images_frontend":"0"}', 5, 2, '', '', 1, 7, '{"robots":"","author":"","rights":"","xreference":""}', 0, 'en-GB', '');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `mqmj3_contentitem_tag_map` (
...
--
-- Table structure for table `mqmj3_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `mqmj3_content_frontpage` (
...
--
-- Table structure for table `mqmj3_content_rating`
--

CREATE TABLE IF NOT EXISTS `mqmj3_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `mqmj3_content_types`
--

CREATE TABLE IF NOT EXISTS `mqmj3_content_types` (
...
--
-- Dumping data for table `mqmj3_content_types`
--

INSERT INTO `mqmj3_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `mqmj3_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `mqmj3_core_log_searches` (
...
--
-- Table structure for table `mqmj3_extensions`
--

CREATE TABLE IF NOT EXISTS `mqmj3_extensions` (
...
--
-- Dumping data for table `mqmj3_extensions`
--

INSERT INTO `mqmj3_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2015 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"088f842018400f0e2c1d76235344faef"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, '', 'language', 'bg-BG', '', 0, 1, 0, 0, '{"name":"\\u0411\\u044a\\u043b\\u0433\\u0430\\u0440\\u0441\\u043a\\u0438","type":"language","creationDate":"2014-05-31","author":"Joomla! Bulgaria","copyright":"Copyright (C) 2002 - 2014 Joomla! Bulgaria. All rights reserved.","authorEmail":"admin@joomla.bg","authorUrl":"http:\\/\\/joomla.bg","version":"3.3.0.1","description":"\\n    <p>\\u041f\\u0440\\u0435\\u0432\\u043e\\u0434 \\u043d\\u0430 Joomla! 3.3 \\u043d\\u0430 \\u0431\\u044a\\u043b\\u0433\\u0430\\u0440\\u0441\\u043a\\u0438 \\u0435\\u0437\\u0438\\u043a. \\u041f\\u043e\\u0432\\u0435\\u0447\\u0435 \\u0438\\u043d\\u0444\\u043e\\u0440\\u043c\\u0430\\u0446\\u0438\\u044f \\u043c\\u043e\\u0436\\u0435\\u0442\\u0435 \\u0434\\u0430 \\u043d\\u0430\\u043c\\u0435\\u0440\\u0438\\u0442\\u0435 \\u043d\\u0430 \\u0441\\u0430\\u0439\\u0442\\u0430 \\u043d\\u0430 <a title=\\"Joomla! Bulgaria\\" href=\\"http:\\/\\/www.joomla.bg\\" target=\\"_blank\\">Joomla! Bulgaria<\\/a>.<\\/p>\\n    ","group":"","filename":"install"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, '', 'language', 'bg-BG', '', 1, 1, 0, 0, '{"name":"\\u0411\\u044a\\u043b\\u0433\\u0430\\u0440\\u0441\\u043a\\u0438","type":"language","creationDate":"2014-05-31","author":"Joomla! Bulgaria","copyright":"Copyright (C) 2002 - 2014 Joomla! Bulgaria. All rights reserved.","authorEmail":"admin@joomla.bg","authorUrl":"http:\\/\\/joomla.bg","version":"3.3.0.1","description":"\\n    <p>\\u041f\\u0440\\u0435\\u0432\\u043e\\u0434 \\u043d\\u0430 Joomla! 3.3 \\u043d\\u0430 \\u0431\\u044a\\u043b\\u0433\\u0430\\u0440\\u0441\\u043a\\u0438 \\u0435\\u0437\\u0438\\u043a. \\u041f\\u043e\\u0432\\u0435\\u0447\\u0435 \\u0438\\u043d\\u0444\\u043e\\u0440\\u043c\\u0430\\u0446\\u0438\\u044f \\u043c\\u043e\\u0436\\u0435\\u0442\\u0435 \\u0434\\u0430 \\u043d\\u0430\\u043c\\u0435\\u0440\\u0438\\u0442\\u0435 \\u043d\\u0430 \\u0441\\u0430\\u0439\\u0442\\u0430 \\u043d\\u0430 <a title=\\"Joomla! Bulgaria\\" href=\\"http:\\/\\/www.joomla.bg\\" target=\\"_blank\\">Joomla! Bulgaria<\\/a>.<\\/p>\\n    ","group":"","filename":"install"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'Bulgarian Language Pack', 'package', 'pkg_bg-BG', '', 0, 1, 1, 0, '{"name":"Bulgarian Language Pack","type":"package","creationDate":"2014-05-31","author":"Joomla! Bulgaria","copyright":"","authorEmail":"admin@joomla.bg","authorUrl":"http:\\/\\/joomla.bg","version":"3.3.0.1","description":"\\n    <p>\\u041f\\u0440\\u0435\\u0432\\u043e\\u0434 \\u043d\\u0430 Joomla! 3.3 \\u043d\\u0430 \\u0431\\u044a\\u043b\\u0433\\u0430\\u0440\\u0441\\u043a\\u0438 \\u0435\\u0437\\u0438\\u043a. \\u041f\\u043e\\u0432\\u0435\\u0447\\u0435 \\u0438\\u043d\\u0444\\u043e\\u0440\\u043c\\u0430\\u0446\\u0438\\u044f \\u043c\\u043e\\u0436\\u0435\\u0442\\u0435 \\u0434\\u0430 \\u043d\\u0430\\u043c\\u0435\\u0440\\u0438\\u0442\\u0435 \\u043d\\u0430 \\u0441\\u0430\\u0439\\u0442\\u0430 \\u043d\\u0430 <a title=\\"Joomla! Bulgaria\\" href=\\"http:\\/\\/www.joomla.bg\\" target=\\"_blank\\">Joomla! Bulgaria<\\/a>.<\\/p>\\n    ","group":"","filename":"pkg_bg-BG"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_finder_filters`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_filters` (
...
--
-- Table structure for table `mqmj3_finder_links`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links` (
...
--
-- Table structure for table `mqmj3_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `mqmj3_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `mqmj3_finder_taxonomy`
--

INSERT INTO `mqmj3_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_finder_terms`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_terms` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `mqmj3_finder_terms_common`
--

INSERT INTO `mqmj3_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `mqmj3_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `mqmj3_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_finder_types`
--

CREATE TABLE IF NOT EXISTS `mqmj3_finder_types` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_languages`
--

CREATE TABLE IF NOT EXISTS `mqmj3_languages` (
...
--
-- Dumping data for table `mqmj3_languages`
--

INSERT INTO `mqmj3_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_menu`
--

CREATE TABLE IF NOT EXISTS `mqmj3_menu` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `mqmj3_menu`
--

INSERT INTO `mqmj3_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Dumping data for table `mqmj3_menu_types`
--

INSERT INTO `mqmj3_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_messages`
--

CREATE TABLE IF NOT EXISTS `mqmj3_messages` (
...
--
-- Table structure for table `mqmj3_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `mqmj3_messages_cfg` (
...
--
-- Table structure for table `mqmj3_modules`
--

CREATE TABLE IF NOT EXISTS `mqmj3_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `mqmj3_modules`
--

INSERT INTO `mqmj3_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Table structure for table `mqmj3_modules_menu`
--

CREATE TABLE IF NOT EXISTS `mqmj3_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `mqmj3_modules_menu`
--

INSERT INTO `mqmj3_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `mqmj3_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `mqmj3_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_overrider`
--

CREATE TABLE IF NOT EXISTS `mqmj3_overrider` (
...
--
-- Table structure for table `mqmj3_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `mqmj3_postinstall_messages` (
...
--
-- Dumping data for table `mqmj3_postinstall_messages`
--

INSERT INTO `mqmj3_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `mqmj3_redirect_links`
--

CREATE TABLE IF NOT EXISTS `mqmj3_redirect_links` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_schemas`
--

CREATE TABLE IF NOT EXISTS `mqmj3_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `mqmj3_schemas`
--

INSERT INTO `mqmj3_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.4.0-2015-02-26');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_session`
--

CREATE TABLE IF NOT EXISTS `mqmj3_session` (
...
--
-- Dumping data for table `mqmj3_session`
--

INSERT INTO `mqmj3_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('b2cpiiq81qkcp65c47grsmhuj2', 1, 0, '1433875108', '__default|a:9:{s:15:"session.counter";i:162;s:19:"session.timer.start";i:1433870768;s:18:"session.timer.last";i:1433875103;s:17:"session.timer.now";i:1433875108;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":9:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:11:"com_modules";O:8:"stdClass":3:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}s:4:"edit";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:2:"id";a:0:{}s:4:"data";N;}}s:3:"add";O:8:"stdClass":1:{s:6:"module";O:8:"stdClass":2:{s:12:"extension_id";N;s:6:"params";N;}}}s:13:"com_languages";O:8:"stdClass":1:{s:9:"installed";O:8:"stdClass":1:{s:8:"ordercol";s:6:"a.name";}}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:11:"com_content";O:8:"stdClass":2:{s:4:"edit";O:8:"stdClass":1:{s:7:"article";O:8:"stdClass":2:{s:4:"data";N;s:2:"id";a:0:{}}}s:8:"articles";O:8:"stdClass":3:{s:6:"filter";a:8:{s:6:"search";s:0:"";s:9:"published";s:0:"";s:11:"category_id";s:0:"";s:5:"level";s:0:"";s:6:"access";s:0:"";s:9:"author_id";s:0:"";s:8:"language";s:0:"";s:3:"tag";s:0:"";}s:4:"list";a:2:{s:12:"fullordering";s:9:"a.id DESC";s:5:"limit";s:2:"20";}s:10:"limitstart";i:0;}}s:14:"com_categories";O:8:"stdClass":1:{s:10:"categories";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:9:"extension";s:11:"com_content";}}}s:9:"com_menus";O:8:"stdClass":2:{s:5:"items";O:8:"stdClass":4:{s:8:"menutype";s:8:"mainmenu";s:10:"limitstart";s:1:"0";s:4:"list";a:2:{s:12:"fullordering";s:9:"a.lft ASC";s:5:"limit";s:2:"20";}s:6:"filter";a:5:{s:6:"search";s:0:"";s:9:"published";s:0:"";s:5:"level";s:0:"";s:6:"access";s:0:"";s:8:"language";s:0:"";}}s:4:"edit";O:8:"stdClass":1:{s:4:"item";O:8:"stdClass":4:{s:4:"data";N;s:4:"type";N;s:4:"link";N;s:8:"menutype";s:8:"mainmenu";}}}s:4:"item";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:8:"menutype";s:8:"mainmenu";}}s:13:"com_templates";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:5:"style";O:8:"stdClass":2:{s:2:"id";a:3:{i:0;i:4;i:1;i:5;i:2;i:7;}s:4:"data";N;}}}}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":28:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"252";s:4:"name";s:10:"Super User";s:8:"username";s:8:"mqmAdmin";s:5:"email";s:10:"xd2@abv.bg";s:8:"password";s:60:"$2y$10$Z.sr4Q9EBQSBRNADPplooum5IyG5k8TQne5XRlIFzU3acBWC09NyK";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-06-09 10:01:15";s:13:"lastvisitDate";s:19:"2015-06-09 15:59:29";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:12:"requireReset";s:1:"0";s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"5c72750badf2257ccb3c1c08a7372af9";s:20:"com_media.return_url";s:26:"index.php?option=com_media";}', 252, 'mqmAdmin'),
('j0j7p6027h2dbbvm2tdh1u1rb4', 0, 1, '1433875064', '__default|a:8:{s:15:"session.counter";i:13;s:19:"session.timer.start";i:1433873757;s:18:"session.timer.last";i:1433874845;s:17:"session.timer.now";i:1433875064;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":2:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}s:9:"separator";s:1:".";}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:13:"\\0\\0\\0userHelper";O:18:"JUserWrapperHelper":0:{}s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:16:"com_mailto.links";a:1:{s:40:"f68323d68b7160c9339782140e09e3e7e51abf46";O:8:"stdClass":2:{s:4:"link";s:32:"http://localhost/index.php/about";s:6:"expiry";i:1433874845;}}}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_tags`
--

CREATE TABLE IF NOT EXISTS `mqmj3_tags` (
  `id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `mqmj3_tags`
--

INSERT INTO `mqmj3_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_template_styles`
--

CREATE TABLE IF NOT EXISTS `mqmj3_template_styles` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `mqmj3_template_styles`
--

INSERT INTO `mqmj3_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Table structure for table `mqmj3_ucm_base`
--

CREATE TABLE IF NOT EXISTS `mqmj3_ucm_base` (
...
--
-- Table structure for table `mqmj3_ucm_content`
--

CREATE TABLE IF NOT EXISTS `mqmj3_ucm_content` (
...
--
-- Table structure for table `mqmj3_ucm_history`
--

CREATE TABLE IF NOT EXISTS `mqmj3_ucm_history` (
...
--
-- Dumping data for table `mqmj3_ucm_history`
--

INSERT INTO `mqmj3_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(2, 1, 1, '', '2015-06-09 18:13:16', 252, 3058, '6ee97896606418e6a704d5408b3236b2074a2e62', '{"id":1,"asset_id":55,"title":"About","alias":"about","introtext":"<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\"><img src=\\"images\\/custom\\/maria-queen-maria-logo.png\\" alt=\\"Maria Queen Maria Logo\\" width=\\"782\\" height=\\"156\\" \\/><\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Maria Queen Maria fashion label was established on a sunny, December day of 2009 under the sign of Sagittarius and Jupiter and a result of a long-standing friendship between a Capricorn and an Aries.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">In less than four years MQM became a major brand and the only Bulgarian label for deconstructive fashion.<br \\/>For the double \\"M\\" stand the talent and visionary work of Mina Kaye and Maria Ilieva - popular and prominent factors in the Bulgarian show business and fashion.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Over the last ten years Mina and Maria developed their own, original fashion line,\\u00a0 believing\\u00a0 that Sofia can now boost with avan-garde deconstructive designs and dictate trends.<br \\/>Maria Queen Maria fashion stores are situated on the the unique Rakovski 193 street.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-06-09 17:36:56","created_by":"252","created_by_alias":"","modified":"2015-06-09 18:13:16","modified_by":"252","checked_out":"252","checked_out_time":"2015-06-09 18:13:10","publish_up":"2015-06-09 17:36:56","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":2,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"0","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"en-GB","xreference":""}', 0),
(3, 1, 1, '', '2015-06-09 18:23:57', 252, 3071, '4a980eb1fc88a4f7f279848fb80697484a130da3', '{"id":1,"asset_id":"55","title":"About","alias":"about","introtext":"<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\"><img src=\\"images\\/custom\\/maria-queen-maria-logo.png\\" alt=\\"Maria Queen Maria Logo\\" width=\\"782\\" height=\\"156\\" \\/><\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Maria Queen Maria fashion label was established on a sunny, December day of 2009 under the sign of Sagittarius and Jupiter and a result of a long-standing friendship between a Capricorn and an Aries.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">In less than four years MQM became a major brand and the only Bulgarian label for deconstructive fashion.<br \\/>For the double \\"M\\" stand the talent and visionary work of Mina Kaye and Maria Ilieva - popular and prominent factors in the Bulgarian show business and fashion.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Over the last ten years Mina and Maria developed their own, original fashion line,\\u00a0 believing\\u00a0 that Sofia can now boost with avan-garde deconstructive designs and dictate trends.<br \\/>Maria Queen Maria fashion stores are situated on the the unique Rakovski 193 street.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-06-09 17:36:56","created_by":"252","created_by_alias":"","modified":"2015-06-09 18:23:57","modified_by":"252","checked_out":"252","checked_out_time":"2015-06-09 18:21:35","publish_up":"2015-06-09 17:36:56","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"0\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"0\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"0\\",\\"show_modify_date\\":\\"0\\",\\"show_publish_date\\":\\"0\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"0\\",\\"show_email_icon\\":\\"0\\",\\"show_vote\\":\\"0\\",\\"show_hits\\":\\"0\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":3,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"1","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"en-GB","xreference":""}', 0),
(4, 1, 1, '', '2015-06-09 18:32:27', 252, 3079, 'c5d03e87d787da0d2d29fea7e5f0c200c494da04', '{"id":1,"asset_id":"55","title":"About","alias":"about","introtext":"<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\"><img src=\\"images\\/custom\\/maria-queen-maria-logo.png\\" alt=\\"Maria Queen Maria Logo\\" width=\\"782\\" height=\\"156\\" \\/><\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Maria Queen Maria fashion label was established on a sunny, December day of 2009 under the sign of Sagittarius and Jupiter and a result of a long-standing friendship between a Capricorn and an Aries.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">In less than four years MQM became a major brand and the only Bulgarian label for deconstructive fashion.<br \\/>For the double \\"M\\" stand the talent and visionary work of Mina Kaye and Maria Ilieva - popular and prominent factors in the Bulgarian show business and fashion.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Over the last ten years Mina and Maria developed their own, original fashion line,\\u00a0 believing\\u00a0 that Sofia can now boost with avan-garde deconstructive designs and dictate trends.<br \\/>Maria Queen Maria fashion stores are situated on the the unique Rakovski 193 street.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-06-09 17:36:56","created_by":"252","created_by_alias":"","modified":"2015-06-09 18:32:27","modified_by":"252","checked_out":"252","checked_out_time":"2015-06-09 18:31:48","publish_up":"2015-06-09 17:36:56","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"0\\",\\"link_category\\":\\"0\\",\\"show_parent_category\\":\\"0\\",\\"link_parent_category\\":\\"0\\",\\"show_author\\":\\"0\\",\\"link_author\\":\\"0\\",\\"show_create_date\\":\\"0\\",\\"show_modify_date\\":\\"0\\",\\"show_publish_date\\":\\"0\\",\\"show_item_navigation\\":\\"0\\",\\"show_icons\\":\\"0\\",\\"show_print_icon\\":\\"0\\",\\"show_email_icon\\":\\"0\\",\\"show_vote\\":\\"0\\",\\"show_hits\\":\\"0\\",\\"show_noauth\\":\\"0\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":4,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"2","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"en-GB","xreference":""}', 0),
(5, 1, 1, '', '2015-06-09 18:34:01', 252, 3083, '13be4fa74b62a56766a4da34949c4c570bf71b26', '{"id":1,"asset_id":"55","title":"About","alias":"about","introtext":"<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\"><img src=\\"images\\/custom\\/maria-queen-maria-logo.png\\" alt=\\"Maria Queen Maria Logo\\" width=\\"782\\" height=\\"156\\" \\/><\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Maria Queen Maria fashion label was established on a sunny, December day of 2009 under the sign of Sagittarius and Jupiter and a result of a long-standing friendship between a Capricorn and an Aries.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">In less than four years MQM became a major brand and the only Bulgarian label for deconstructive fashion.<br \\/>For the double \\"M\\" stand the talent and visionary work of Mina Kaye and Maria Ilieva - popular and prominent factors in the Bulgarian show business and fashion.<\\/p>\\r\\n<p style=\\"margin: 8px 0px 14px; padding: 0px; color: #46462b; font-family: arial; font-size: 12px; line-height: 18px;\\">Over the last ten years Mina and Maria developed their own, original fashion line,\\u00a0 believing\\u00a0 that Sofia can now boost with avan-garde deconstructive designs and dictate trends.<br \\/>Maria Queen Maria fashion stores are situated on the the unique Rakovski 193 street.<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-06-09 17:36:56","created_by":"252","created_by_alias":"","modified":"2015-06-09 18:34:01","modified_by":"252","checked_out":"252","checked_out_time":"2015-06-09 18:32:27","publish_up":"2015-06-09 17:36:56","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"0\\",\\"show_tags\\":\\"0\\",\\"show_intro\\":\\"0\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"0\\",\\"link_category\\":\\"0\\",\\"show_parent_category\\":\\"0\\",\\"link_parent_category\\":\\"0\\",\\"show_author\\":\\"0\\",\\"link_author\\":\\"0\\",\\"show_create_date\\":\\"0\\",\\"show_modify_date\\":\\"0\\",\\"show_publish_date\\":\\"0\\",\\"show_item_navigation\\":\\"0\\",\\"show_icons\\":\\"0\\",\\"show_print_icon\\":\\"0\\",\\"show_email_icon\\":\\"0\\",\\"show_vote\\":\\"0\\",\\"show_hits\\":\\"0\\",\\"show_noauth\\":\\"0\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"0\\",\\"show_article_options\\":\\"0\\",\\"show_urls_images_backend\\":\\"0\\",\\"show_urls_images_frontend\\":\\"0\\"}","version":5,"ordering":"2","metakey":"","metadesc":"","access":"1","hits":"5","metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"en-GB","xreference":""}', 0);

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_updates`
--

CREATE TABLE IF NOT EXISTS `mqmj3_updates` (
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 COMMENT='Available Updates';

--
-- Dumping data for table `mqmj3_updates`
--

INSERT INTO `mqmj3_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(2, 3, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(3, 3, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/nn-NO_details.xml', '', ''),
(4, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(5, 3, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(6, 3, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(7, 3, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(8, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(9, 3, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(10, 3, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(11, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(12, 3, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(13, 3, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(14, 3, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.3.3.15', '', 'http://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
...
(18, 3, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.4.1.3', '', 'http://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(19, 3, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(20, 3, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.4.1.2', '', 'http://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(21, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.4.0.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(22, 3, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
...
(25, 3, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(26, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.4.1.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
...
(29, 3, 0, 'FrenchCA', '', 'pkg_fr-CA', 'package', '', 0, '3.3.6.1', '', 'http://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
(30, 3, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.3.0.1', '', 'http://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
(31, 3, 0, 'Sinhala', '', 'pkg_si-LK', 'package', '', 0, '3.3.1.1', '', 'http://update.joomla.org/language/details3/si-LK_details.xml', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_update_sites`
--

CREATE TABLE IF NOT EXISTS `mqmj3_update_sites` (
...
--
-- Dumping data for table `mqmj3_update_sites`
--

INSERT INTO `mqmj3_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1433874465, ''),
(2, 'Joomla! Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1433874465, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1433874463, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1433874463, '');

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `mqmj3_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

--
-- Dumping data for table `mqmj3_update_sites_extensions`
--

INSERT INTO `mqmj3_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(3, 10002),
...
--
-- Table structure for table `mqmj3_usergroups`
--

CREATE TABLE IF NOT EXISTS `mqmj3_usergroups` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `mqmj3_usergroups`
--

INSERT INTO `mqmj3_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `mqmj3_users`
--

CREATE TABLE IF NOT EXISTS `mqmj3_users` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `mqmj3_users`
--

INSERT INTO `mqmj3_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(252, 'Super User', 'mqmAdmin', 'xd2@abv.bg', '$2y$10$Z.sr4Q9EBQSBRNADPplooum5IyG5k8TQne5XRlIFzU3acBWC09NyK', 0, 1, '2015-06-09 10:01:15', '2015-06-09 17:26:28', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_user_keys`
--

CREATE TABLE IF NOT EXISTS `mqmj3_user_keys` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `mqmj3_user_notes`
--

CREATE TABLE IF NOT EXISTS `mqmj3_user_notes` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `mqmj3_user_profiles`
--

CREATE TABLE IF NOT EXISTS `mqmj3_user_profiles` (
...
--
-- Table structure for table `mqmj3_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `mqmj3_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `mqmj3_user_usergroup_map`
--

INSERT INTO `mqmj3_user_usergroup_map` (`user_id`, `group_id`) VALUES
(252, 8);

-- --------------------------------------------------------

--
-- Table structure for table `mqmj3_viewlevels`
--

CREATE TABLE IF NOT EXISTS `mqmj3_viewlevels` (
  `id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `mqmj3_viewlevels`
--

INSERT INTO `mqmj3_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Indexes for table `mqmj3_assets`
--
ALTER TABLE `mqmj3_assets`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_asset_name` (`name`), ADD KEY `idx_lft_rgt` (`lft`,`rgt`), ADD KEY `idx_parent_id` (`parent_id`);

--
-- Indexes for table `mqmj3_associations`
--
ALTER TABLE `mqmj3_associations`
  ADD PRIMARY KEY (`context`,`id`), ADD KEY `idx_key` (`key`);

--
-- Indexes for table `mqmj3_banners`
--
ALTER TABLE `mqmj3_banners`
...
--
-- Indexes for table `mqmj3_banner_clients`
--
ALTER TABLE `mqmj3_banner_clients`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_own_prefix` (`own_prefix`), ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indexes for table `mqmj3_banner_tracks`
--
ALTER TABLE `mqmj3_banner_tracks`
...
--
-- Indexes for table `mqmj3_categories`
--
ALTER TABLE `mqmj3_categories`
...
--
-- Indexes for table `mqmj3_contact_details`
--
ALTER TABLE `mqmj3_contact_details`
...
--
-- Indexes for table `mqmj3_content`
--
ALTER TABLE `mqmj3_content`
...
--
-- Indexes for table `mqmj3_contentitem_tag_map`
--
ALTER TABLE `mqmj3_contentitem_tag_map`
...
--
-- Indexes for table `mqmj3_content_frontpage`
--
ALTER TABLE `mqmj3_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `mqmj3_content_rating`
--
ALTER TABLE `mqmj3_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `mqmj3_content_types`
--
ALTER TABLE `mqmj3_content_types`
  ADD PRIMARY KEY (`type_id`), ADD KEY `idx_alias` (`type_alias`);

--
-- Indexes for table `mqmj3_extensions`
--
ALTER TABLE `mqmj3_extensions`
...
--
-- Indexes for table `mqmj3_finder_filters`
--
ALTER TABLE `mqmj3_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `mqmj3_finder_links`
--
ALTER TABLE `mqmj3_finder_links`
...
--
-- Indexes for table `mqmj3_finder_links_terms0`
--
ALTER TABLE `mqmj3_finder_links_terms0`
...
--
-- Indexes for table `mqmj3_finder_links_terms1`
--
ALTER TABLE `mqmj3_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms2`
--
ALTER TABLE `mqmj3_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms3`
--
ALTER TABLE `mqmj3_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms4`
--
ALTER TABLE `mqmj3_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms5`
--
ALTER TABLE `mqmj3_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms6`
--
ALTER TABLE `mqmj3_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms7`
--
ALTER TABLE `mqmj3_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms8`
--
ALTER TABLE `mqmj3_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_terms9`
--
ALTER TABLE `mqmj3_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_termsa`
--
ALTER TABLE `mqmj3_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_termsb`
--
ALTER TABLE `mqmj3_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_termsc`
--
ALTER TABLE `mqmj3_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_termsd`
--
ALTER TABLE `mqmj3_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_termse`
--
ALTER TABLE `mqmj3_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_links_termsf`
--
ALTER TABLE `mqmj3_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `mqmj3_finder_taxonomy`
--
ALTER TABLE `mqmj3_finder_taxonomy`
...
--
-- Indexes for table `mqmj3_finder_taxonomy_map`
--
ALTER TABLE `mqmj3_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`), ADD KEY `link_id` (`link_id`), ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `mqmj3_finder_terms`
--
ALTER TABLE `mqmj3_finder_terms`
...
--
-- Indexes for table `mqmj3_finder_terms_common`
--
ALTER TABLE `mqmj3_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`), ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `mqmj3_finder_tokens`
--
ALTER TABLE `mqmj3_finder_tokens`
  ADD KEY `idx_word` (`term`), ADD KEY `idx_context` (`context`);

--
-- Indexes for table `mqmj3_finder_tokens_aggregate`
--
ALTER TABLE `mqmj3_finder_tokens_aggregate`
  ADD KEY `token` (`term`), ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `mqmj3_finder_types`
--
ALTER TABLE `mqmj3_finder_types`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `mqmj3_languages`
--
ALTER TABLE `mqmj3_languages`
...
--
-- Indexes for table `mqmj3_menu`
--
ALTER TABLE `mqmj3_menu`
...
--
-- Indexes for table `mqmj3_menu_types`
--
ALTER TABLE `mqmj3_menu_types`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `mqmj3_messages`
--
ALTER TABLE `mqmj3_messages`
  ADD PRIMARY KEY (`message_id`), ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `mqmj3_messages_cfg`
--
ALTER TABLE `mqmj3_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `mqmj3_modules`
--
ALTER TABLE `mqmj3_modules`
  ADD PRIMARY KEY (`id`), ADD KEY `published` (`published`,`access`), ADD KEY `newsfeeds` (`module`,`published`), ADD KEY `idx_language` (`language`);

--
-- Indexes for table `mqmj3_modules_menu`
--
ALTER TABLE `mqmj3_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `mqmj3_newsfeeds`
--
ALTER TABLE `mqmj3_newsfeeds`
...
--
-- Indexes for table `mqmj3_overrider`
--
ALTER TABLE `mqmj3_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `mqmj3_postinstall_messages`
--
ALTER TABLE `mqmj3_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `mqmj3_redirect_links`
--
ALTER TABLE `mqmj3_redirect_links`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_link_old` (`old_url`), ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `mqmj3_schemas`
--
ALTER TABLE `mqmj3_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `mqmj3_session`
--
ALTER TABLE `mqmj3_session`
  ADD PRIMARY KEY (`session_id`), ADD KEY `userid` (`userid`), ADD KEY `time` (`time`);

--
-- Indexes for table `mqmj3_tags`
--
ALTER TABLE `mqmj3_tags`
...
--
-- Indexes for table `mqmj3_template_styles`
--
ALTER TABLE `mqmj3_template_styles`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_template` (`template`), ADD KEY `idx_home` (`home`);

--
-- Indexes for table `mqmj3_ucm_base`
--
ALTER TABLE `mqmj3_ucm_base`
...
--
-- Indexes for table `mqmj3_ucm_content`
--
ALTER TABLE `mqmj3_ucm_content`
...
--
-- Indexes for table `mqmj3_ucm_history`
--
ALTER TABLE `mqmj3_ucm_history`
  ADD PRIMARY KEY (`version_id`), ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`), ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `mqmj3_updates`
--
ALTER TABLE `mqmj3_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `mqmj3_update_sites`
--
ALTER TABLE `mqmj3_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `mqmj3_update_sites_extensions`
--
ALTER TABLE `mqmj3_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `mqmj3_usergroups`
--
ALTER TABLE `mqmj3_usergroups`
...
--
-- Indexes for table `mqmj3_users`
--
ALTER TABLE `mqmj3_users`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_name` (`name`), ADD KEY `idx_block` (`block`), ADD KEY `username` (`username`), ADD KEY `email` (`email`);

--
-- Indexes for table `mqmj3_user_keys`
--
ALTER TABLE `mqmj3_user_keys`
...
--
-- Indexes for table `mqmj3_user_notes`
--
ALTER TABLE `mqmj3_user_notes`
  ADD PRIMARY KEY (`id`), ADD KEY `idx_user_id` (`user_id`), ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `mqmj3_user_profiles`
--
ALTER TABLE `mqmj3_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `mqmj3_user_usergroup_map`
--
ALTER TABLE `mqmj3_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `mqmj3_viewlevels`
--
ALTER TABLE `mqmj3_viewlevels`
...
--
-- AUTO_INCREMENT for table `mqmj3_assets`
--
ALTER TABLE `mqmj3_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT for table `mqmj3_banners`
--
ALTER TABLE `mqmj3_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_banner_clients`
--
ALTER TABLE `mqmj3_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_categories`
--
ALTER TABLE `mqmj3_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `mqmj3_contact_details`
--
ALTER TABLE `mqmj3_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_content`
--
ALTER TABLE `mqmj3_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `mqmj3_content_types`
--
ALTER TABLE `mqmj3_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT for table `mqmj3_extensions`
--
ALTER TABLE `mqmj3_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10003;
--
-- AUTO_INCREMENT for table `mqmj3_finder_filters`
--
ALTER TABLE `mqmj3_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_finder_links`
--
ALTER TABLE `mqmj3_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_finder_taxonomy`
--
ALTER TABLE `mqmj3_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `mqmj3_finder_terms`
--
ALTER TABLE `mqmj3_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_finder_types`
--
ALTER TABLE `mqmj3_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_languages`
--
ALTER TABLE `mqmj3_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `mqmj3_menu`
--
ALTER TABLE `mqmj3_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=105;
--
-- AUTO_INCREMENT for table `mqmj3_menu_types`
--
ALTER TABLE `mqmj3_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `mqmj3_messages`
--
ALTER TABLE `mqmj3_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_modules`
--
ALTER TABLE `mqmj3_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `mqmj3_newsfeeds`
--
ALTER TABLE `mqmj3_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_overrider`
--
ALTER TABLE `mqmj3_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `mqmj3_postinstall_messages`
--
ALTER TABLE `mqmj3_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `mqmj3_redirect_links`
--
ALTER TABLE `mqmj3_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_tags`
--
ALTER TABLE `mqmj3_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `mqmj3_template_styles`
--
ALTER TABLE `mqmj3_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `mqmj3_ucm_content`
--
ALTER TABLE `mqmj3_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_ucm_history`
--
ALTER TABLE `mqmj3_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `mqmj3_updates`
--
ALTER TABLE `mqmj3_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=32;
--
-- AUTO_INCREMENT for table `mqmj3_update_sites`
--
ALTER TABLE `mqmj3_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `mqmj3_usergroups`
--
ALTER TABLE `mqmj3_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `mqmj3_users`
--
ALTER TABLE `mqmj3_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=253;
--
-- AUTO_INCREMENT for table `mqmj3_user_keys`
--
ALTER TABLE `mqmj3_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_user_notes`
--
ALTER TABLE `mqmj3_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `mqmj3_viewlevels`
--
ALTER TABLE `mqmj3_viewlevels`
